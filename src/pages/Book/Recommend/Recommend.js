...
const Recommend = () => {
  ...
  // 请求轮播图部分
  useEffect(() => {
    fetch(`https://novel.juhe.im/category-info?gender=female&type=hot&major=现代言情&minor=&start=40&limit=5`)
      .then(res => res.json())
      .then(data => {
  ...
  // 请求最好看的书
  useEffect(() => {
    fetch(`https://novel.juhe.im/category-info?gender=male&type=hot&major=科幻&minor=&start=0&limit=8`)
      .then(res => res.json())
      .then(data => {
        useIsLoading(false)
  ...
  // 出版精品
  useEffect(() => {
    fetch(`https://novel.juhe.im/category-info?gender=female&type=hot&major=现代言情&minor=&start=20&limit=4`)
      .then(res => res.json())
      .then(data => {
  ...
  // 精品聚会
  useEffect(() => {
    fetch(`https://novel.juhe.im/category-info?gender=male&type=hot&major=历史&minor=&start=10&limit=18`)
      .then(res => res.json())
      .then(data => {
  ...
  // 新品书籍
  useEffect(() => {
    fetch(`https://novel.juhe.im/category-info?gender=female&type=hot&major=古代言情&minor=&start=10&limit=8`)
      .then(res => res.json())
      .then(data => {
  ...
  // 原创作品
  useEffect(() => {
    fetch(`https://novel.juhe.im/category-info?gender=female&type=hot&major=现代言情&minor=&start=30&limit=8`)
      .then(res => res.json())
      .then(data => {
  ...
  getBanner = () => {
    return new Promise((resolve, reject) => {
      fetch(`https://novel.juhe.im/category-info?gender=female&type=hot&major=现代言情&minor=&start=0&limit=5`)
        .then(res => res.json())
        .then(data => {
          resolve(data.books)
        })
  ...
  getGoodBook = () => {
    return new Promise((resolve, reject) => {
      fetch(`https://novel.juhe.im/category-info?gender=male&type=hot&major=科幻&minor=&start=0&limit=4`)
        .then(res => res.json())
        .then(data => {
          console.log(333)
          resolve(data.books)
