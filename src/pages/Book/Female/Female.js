...
const Female = () => {
  const Static = `https://statics.zhuishushenqi.com`
  const limit = 20
  ...
  // 请求最好看的书
  useEffect(() => {
    fetch(`https://novel.juhe.im/category-info?gender=female&type=hot&major=青春校园&minor=&start=0&limit=12`)
      .then(res => res.json())
      .then(data => {
        useIsLoading(false)
  ...
  // 出版精品
  useEffect(() => {
    fetch(`https://novel.juhe.im/category-info?gender=female&type=hot&major=现代言情&minor=&start=10&limit=8`)
      .then(res => res.json())
      .then(data => {
  ...
  // 精品聚会
  useEffect(() => {
    fetch(`https://novel.juhe.im/category-info?gender=female&type=hot&major=古代言情&minor=&start=0&limit=8`)
      .then(res => res.json())
      .then(data => {
  ...
  // 原创作品
  useEffect(() => {
    fetch(`https://novel.juhe.im/category-info?gender=female&type=hot&major=古代言情&minor=&start=20&limit=8`)
      .then(res => res.json())
      .then(data => {
  ...
  useEffect(() => {
    const getMoreBooks = (limit) => {
      ...
      fetch(`https://novel.juhe.im/category-info?gender=female&type=hot&major=现代言情&minor=&start=${start}&limit=${limit}`)
        .then(res => res.json())
        .then(data => {
