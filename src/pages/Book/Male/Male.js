...
const Male = () => {
  ...
  // 请求轮播图部分
  useEffect(() => {
    fetch(`https://novel.juhe.im/category-info?gender=male&type=hot&major=游戏&minor=&start=0&limit=4`)
      .then(res => res.json())
      .then(data => {
  ...
  // 请求最好看的书
  useEffect(() => {
    fetch(`https://novel.juhe.im/category-info?gender=male&type=hot&major=奇幻&minor=&start=0&limit=8`)
      .then(res => res.json())
      .then(data => {
        useIsLoading(false)
  ...
  // 出版精品
  useEffect(() => {
    fetch(`https://novel.juhe.im/category-info?gender=male&type=hot&major=奇幻&minor=&start=20&limit=6`)
      .then(res => res.json())
      .then(data => {
  ...
  // 精品聚会
  useEffect(() => {
    fetch(`https://novel.juhe.im/category-info?gender=male&type=hot&major=轻小说&minor=&start=10&limit=8`)
      .then(res => res.json())
      .then(data => {
  ...
  // 新品书籍
  useEffect(() => {
    fetch(`https://novel.juhe.im/category-info?gender=male&type=hot&major=都市&minor=&start=10&limit=8`)
      .then(res => res.json())
      .then(data => {
  ...
  // 原创作品
  useEffect(() => {
    fetch(`https://novel.juhe.im/category-info?gender=male&type=hot&major=仙侠&minor=&start=0&limit=8`)
      .then(res => res.json())
      .then(data => {
  ...
  useEffect(() => {
    const getMoreBooks = (limit) => {
      ...
      fetch(`https://novel.juhe.im/category-info?gender=male&type=hot&major=奇幻&minor=&start=${start}&limit=${limit}`)
        .then(res => res.json())
        .then(data => {
