...
import tabDetailJson from '../../../../mock/comicDetail_tab1.json'
import gridJson from '../../../../mock/home_comic_books.json'
...
class TabDetail extends Component {
    ...
    getComicIntroduce = () => {
        ...
        //     })
        this.setState({
            ComicIntroduce: tabDetailJson.data
        })
    }
    // 六宫格数据的请求
    getComiclists = () => {
        ...
        //     })
        this.setState({
            comiclists: gridJson.data.blockList
        })
    }
