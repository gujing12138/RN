...
import CartoonJson from '../../../mock/home_comic.json'
...
class Home extends React.Component {
  ...
  getCatoonBanner = () => {
    ...
    this.setState({
      isRefreshing: false,
      images: CartoonJson.data.banner,
      lists: CartoonJson.data.blockList,
      redgirl: CartoonJson.data.recommendEveryDay,
      todayAdvice: CartoonJson.data.updateTodayList
    })
  }
